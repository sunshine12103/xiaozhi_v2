...
#define RIGHT_LEG_PIN GPIO_NUM_1
#define RIGHT_FOOT_PIN GPIO_NUM_9
#define LEFT_LEG_PIN GPIO_NUM_3
#define LEFT_FOOT_PIN GPIO_NUM_8
#define LEFT_HAND_PIN GPIO_NUM_5
...
#define WAKE_UP_BUTTON_GPIO GPIO_NUM_4
